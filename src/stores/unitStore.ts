    ...
    (set, get) => ({
      units: [
        ...
        },
        {
          ...
          createdAt: Date.now(),
          words: [
            { id: 'w36', unitId: 'demo-unit-3', word: 'rice', phonetic: '/raɪs/', meaning: '米饭' },
            { id: 'w37', unitId: 'demo-unit-3', word: 'noodle', phonetic: '/ˈnuːdl/', meaning: '面条' },
            { id: 'w38', unitId: 'demo-unit-3', word: 'carrot', phonetic: '/ˈkærət/', meaning: '胡萝卜' },
            { id: 'w39', unitId: 'demo-unit-3', word: 'apple', phonetic: '/ˈæpl/', meaning: '苹果' },
            { id: 'w40', unitId: 'demo-unit-3', word: 'banana', phonetic: '/bəˈnænə/', meaning: '香蕉' },
            { id: 'w41', unitId: 'demo-unit-3', word: 'tomato', phonetic: '/təˈmeɪtoʊ/', meaning: '西红柿' },
            { id: 'w42', unitId: 'demo-unit-3', word: 'sunny', phonetic: '/ˈsʌni/', meaning: '晴朗的' },
            { id: 'w43', unitId: 'demo-unit-3', word: 'rainy', phonetic: '/ˈreɪni/', meaning: '下雨的' },
            { id: 'w44', unitId: 'demo-unit-3', word: 'snowy', phonetic: '/ˈsnoʊi/', meaning: '下雪的' },
          ],
        },
      ],
